...
function getLinearEquationRoot(a, b) {
  if (a === 0) {
    if (b === 0) {
      // Уравнение 0*x + 0 = 0 имеет бесконечно много решений
      return NaN; // Или можно обработать иначе
    } else {
      // Уравнение 0*x + b = 0, где b ≠ 0, решений нет
      return NaN;
    }
  }
  return -b / a;
...
function getIntegerOnString(str, base) {
  ...
  // Используем регулярное выражение, чтобы найти целую часть числа в начале строки
  // с возможным знаком и без дробной части
